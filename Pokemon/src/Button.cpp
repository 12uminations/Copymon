...
///////////////////////////////////////////////////////
Start::Start() {
	static SDL_Texture* Heal = IMG_LoadTexture(ren, "Assent/StartExit.png");
	tex = Heal;
...
void Exit::setPos(int x, int y) {
	drect.x = x;
	drect.y = y;
}
///////////////////////////////////////////////////////
Back_button::Back_button() {
	static SDL_Texture* Heal = IMG_LoadTexture(ren, "Assent/BackArrow1.png");
	tex = Heal;
...
void Back_button::update(Mouse& mouse) {
	if (SDL_HasIntersection(&drect, &mouse.point)) {
		isSelected = true;
		drect.h = 45;
		drect.w = 45;
...
void Back_button::draws() {
	SDL_RenderCopy(ren, tex, &srect, &drect);
}
void Back_button::setPos(int x, int y) {
	drect.x = x;
	drect.y = y;
}
